...
class Post 
{
    ...
    [
        ...
        "detail" => "Aplikasi desktop dimulai dari modul penjualan untuk cetak faktur dan surat jalan, lalu faktur masuk ke penagihan dan dibuatkan DTP (Daftar Tagihan Piutang), setelah melakukan penagihan hasilnya masuk ke kasir, dan keuangan. Selain itu aplikasi ini terkoneksi juga ke bagian pajak, sehingga memudahkan bagian pajak untuk melakukan perhitungan dan ekspor ke efaktur. Setelah semua selesai menginput, maka data akan diolah oleh departemen accounting, antara lain aging, jurnal, neraca, dll. Seluruh proses ini terkoneksi secara sistem, sehingga tidak perlu menginput ulang disetiap departemen.
            ...
            <br><img src='img/erp/1.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            <br><img src='img/erp/2.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            <br><img src='img/erp/3.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            <br><img src='img/erp/4.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            <br><img src='img/erp/5.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            <br><img src='img/erp/6.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            <br><img src='img/erp/7.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            <br><img src='img/erp/8.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            <br><img src='img/erp/9.jpg' alt='Form ERP' class='img-thumbnail img-fluid'>
            "
    ],
    [
        ...
        "detail" => "Aplikasi desktop yang dibuat untuk mempermudah user hrd untuk mengecek absensi dan menginput payroll. Terdapat tingkatan user, dimana user tingkat dibawah tidak bisa melihat yang diinput oleh user dengan tingkat diatasnya sehingga memudahkan user untuk menginput data payroll secara bersamaan.
            ...
            <br><img src='img/payrollhrd/1.jpg' alt='Form Payroll' class='img-thumbnail img-fluid'>
            <br><img src='img/payrollhrd/2.jpg' alt='Form Payroll' class='img-thumbnail img-fluid'>
            <br><img src='img/payrollhrd/3.jpg' alt='Form Payroll' class='img-thumbnail img-fluid'>
            <br><img src='img/payrollhrd/4.jpg' alt='Form Payroll' class='img-thumbnail img-fluid'>
            <br><img src='img/payrollhrd/5.jpg' alt='Form Payroll' class='img-thumbnail img-fluid'>
            "
    ],
    [
        ...
        "detail" => "Aplikasi mobile android yang dibuat untuk mempermudah para sales dalam menginput surat pesanan, sehingga tidak perlu lagi dengan cara manual. Karena data yang masuk akan secara sistem terhubung ke aplikasi desktop yang ada.
            <br>Berikut beberapa contoh form yang ada di dalam program :
            <br><img src='img/salesapps/1.jpg' alt='Form Sales Apps' class='img-thumbnail img-fluid'>
            <br><img src='img/salesapps/2.jpg' alt='Form Sales Apps' class='img-thumbnail img-fluid'>
            <br><img src='img/salesapps/3.jpg' alt='Form Sales Apps' class='img-thumbnail img-fluid'>
            <br><img src='img/salesapps/4.jpg' alt='Form Sales Apps' class='img-thumbnail img-fluid'>
            <br><img src='img/salesapps/5.jpg' alt='Form Sales Apps' class='img-thumbnail img-fluid'>
            <br><img src='img/salesapps/6.jpg' alt='Form Sales Apps' class='img-thumbnail img-fluid'>
            <br><img src='img/salesapps/7.jpg' alt='Form Sales Apps' class='img-thumbnail img-fluid'>
            "
    ],
    [
        ...
        "detail" => "Dibuat custom sesuai dengan request dari owner untuk menghandle item yang variannya mencapai ratusan ribu, terdapat modul khusus untuk impor data barang dari file csv. Dikarenakan data yang diimpor mencapai ratusan ribu item, maka disetiap tampilan master barang dibagi per halaman selain itu terdapat fitur search item untuk memudahkan pencarian item yang jumlahnya cukup banyak. Ditambah lagi fitur input menggunakan barcode, membuat aplikasi ini sangat mudah digunakan.
            <br>Berikut beberapa contoh form yang ada di dalam program :
            <br><img src='img/sparepart/1.jpg' alt='Form Sparepart' class='img-thumbnail img-fluid'>
            <br><img src='img/sparepart/2.jpg' alt='Form Sparepart' class='img-thumbnail img-fluid'>
            <br><img src='img/sparepart/3.jpg' alt='Form Sparepart' class='img-thumbnail img-fluid'>
            <br><img src='img/sparepart/4.jpg' alt='Form Sparepart' class='img-thumbnail img-fluid'>
            <br><img src='img/sparepart/5.jpg' alt='Form Sparepart' class='img-thumbnail img-fluid'>
            <br><img src='img/sparepart/6.jpg' alt='Form Sparepart' class='img-thumbnail img-fluid'>
            "
    ],
    [
        ...
        "detail" => "Software yang cocok untuk digunakan pada usaha retail. Kaya akan fitur, bahkan dapat dicustom sesuai keinginan user. Dilengkapi dengan berbagai fitur keamanan, seperti otorisasi password dimana hanya user dengan level supervisor keatas yang dapat menjalankan fitur-fitur tertentu. Terdapat juga fitur pending transaksi sehingga antrian tidak perlu menunggu lama. Fitur laporan pemasukan harian, kartu stok dan laporan penjualan POS memastikan bahwa barang yang keluar dan nominal uang yang masuk benar sesuai adanya.
            <br>Berikut beberapa contoh form yang ada di dalam program :
            <br><img src='img/pos/1.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            <br><img src='img/pos/2.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            <br><img src='img/pos/3.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            <br><img src='img/pos/4.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            <br><img src='img/pos/5.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            <br><img src='img/pos/6.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            <br><img src='img/pos/7.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            <br><img src='img/pos/8.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            <br><img src='img/pos/9.jpg' alt='Form POS' class='img-thumbnail img-fluid'>
            "
    ]
    ];
